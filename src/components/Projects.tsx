...
const proyectos: Proyecto[] = [
  {
    ...
    imagenes: [
      "/Portfolio/img/SAG1.png",
      "/Portfolio/img/SAG2.png",
      "/Portfolio/img/SAG3.png",
      "/Portfolio/img/SAG4.png",
      "/Portfolio/img/SAG5.png",
      "/Portfolio/img/SAG6.png",
    ],
  ...
  },
  {
    ...
    imagenes: [
      "/Portfolio/img/SGC1.png",
      "/Portfolio/img/SGC2.png",
      "/Portfolio/img/SGC3.png",
      "/Portfolio/img/SGC4.png",
      "/Portfolio/img/SGC5.png",
    ],
  ...
  },
  {
    ...
    imagenes: ["/Portfolio/img/SF1.png", "/Portfolio/img/SF2.png", "/Portfolio/img/SF3.png", "/Portfolio/img/SF4.png"],
